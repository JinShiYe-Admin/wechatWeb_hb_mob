    ...
    <div class="weui_tab footer-menu">
        <div class="weui-tabbar">
            ...
            <a href="#" class="weui-tabbar__item weui-bar__item--on">
                <div class="wrap">
                    <img class="img" src="images/pic_ico_workdetail.png" alt="">
                </div>
		...
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/demoCssJs/vue.min.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/appweb/choose-file.js'></script>
		...
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/PublicProtocol.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/utils/utils.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/utils/storageutil.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/lib/plupload/moxie.min.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/lib/plupload/plupload.full.min.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/lib/qiniu/qiniu.min.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/utils/cryption.js'></script>
		<script src='<%=Jsy.Weixin.QY.Suite.Com.Config.GetKey("schwebadminurl")%>js/utils/cloudutil.js'></script>
