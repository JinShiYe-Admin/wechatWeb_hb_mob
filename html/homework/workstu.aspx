...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link rel="stylesheet" href="https://jsypay.jiaobaowang.net/wxthadmin/css/mui.min.css" />
	...
	<body ontouchstart>
		...
		<div id="submitHomework">
			...
			<a href="https://jsypay.jiaobaowang.net/wxthadmin/html/appWeb/attendance/getAttendList.html" class="weui-btn weui-btn_primary">考勤查询</a>
		...
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/appweb/choose-file.js'></script>
		...
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/lib/plupload/moxie.min.js'></script>
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/lib/plupload/plupload.full.min.js'></script>
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/lib/qiniu/qiniu.min.js'></script>
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/utils/cryption.js'></script>
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/utils/cloudutil.js'></script>
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/utils/compress.js'></script>
		<script src='https://jsypay.jiaobaowang.net/wxthadmin/js/utils/pluploadutil.js'></script>
		<script>
