		...
		l.addFileFilter("mime_types", function(e, t, i) {
			...
			function m(e, i, r) {
				function s(e, i, n) {
					...
					switch(e) {
						...
						case "filters":
							"array" === l.typeOf(i) && (i = {
								mime_types: i
							}), n ? l.extend(S.filters, i) : S.filters = i, i.mime_types && ("string" === l.typeOf(i.mime_types) && (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)), i.mime_types.regexp = function(e) {
								var t = [];
				...
				"object" == typeof e ? l.each(e, function(e, t) {
					s(t, e, r)
				}) : s(e, i, r), r ? (S.required_features = n(l.extend({}, S)), P = n(l.extend({}, S, {
					required_features: !0
				}))) : u && (a.trigger("Destroy"), g.call(a, S, function(e) {
			...
			S = {
				...
				removeFile: function(e) {
					for(var t = "string" == typeof e ? e : e.id, i = x.length - 1; i >= 0; i--)
