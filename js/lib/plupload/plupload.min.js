...
! function(e, t) {
	...
	"function" == typeof define && define.amd ? define("plupload", [], i) : "object" == typeof module && module.exports ? module.exports = i() : e.plupload = i()
	...
	! function(e, t) {
		...
		n("moxie/core/utils/Basic", [], function() {
			...
			function a(t, i, n) {
				...
				return c(n, function(n, u) {
					u > 0 && c(n, function(n, u) {
						var c = -1 !== p(e(n), ["array", "object"]);
						return n === r || t && o[u] === r ? !0 : (c && i && (n = s(n)), e(o[u]) === e(n) && c ? a(t, i, [o[u], n]) : o[u] = n, void 0)
					})
				}), o
			}
			...
			function t(e, t, i) {
				...
				for(e = a(e), t = a(t), r = Math.max(e.length, t.length), n = 0; r > n; n++)
					if(e[n] != t[n]) {
			...
			var i = function(e) {
					var t = "",
						...
						c = {
							rgx: function() {
								for(var t, i, s, a, u, c, l, d = 0, h = arguments; d < h.length; d += 2) {
									var p = h[d],
										m = h[d + 1];
									if(typeof t === r) {
										t = {};
										for(a in m) u = m[a], typeof u === o ? t[u[0]] = e : t[u] = e
									}
									for(i = s = 0; i < p.length; i++)
										if(c = p[i].exec(this.getUA())) {
											for(a = 0; a < m.length; a++) l = c[++s], u = m[a], typeof u === o && u.length > 0 ? 2 == u.length ? t[u[0]] = typeof u[1] == n ? u[1].call(this, l) : u[1] : 3 == u.length ? t[u[0]] = typeof u[1] !== n || u[1].exec && u[1].test ? l ? l.replace(u[1], u[2]) : e : l ? u[1].call(this, l, u[2]) : e : 4 == u.length && (t[u[0]] = l ? u[3].call(this, l.replace(u[1], u[2])) : e) : t[u] = l ? l : e;
											break
										}
									if(c) break
								}
								...
								for(var r in n)
									if(typeof n[r] === o && n[r].length > 0) {
										for(var s = 0; s < n[r].length; s++)
											if(u.has(n[r][s], t)) return r === i ? e : r
						...
						d = {
							browser: [
								...
								[s, [a, c.str, l.browser.oldsafari.version]],
							...
							os: [
								...
								[s, [a, c.str, l.os.windows.version]],
								[/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
								[
									[s, "Windows"],
									[a, c.str, l.os.windows.version]
								],
								[/\((bb)(10);/i],
								[
									[s, "BlackBerry"], a
			...
			var t = function(e) {
				...
				s = function(t, i) {
					...
					var r, o, s, a = 0,
						u = 0,
						c = document;
					if(t = t, i = i || c.body, t && t.getBoundingClientRect && "IE" === e.browser && (!c.documentMode || c.documentMode < 8)) return o = n(t), s = n(i), {
						x: o.x - s.x,
						y: o.y - s.y
					};
			...
			var n = {},
				...
				o = function(o, s, a, u) {
					var c, l;
					s = s.toLowerCase(), o.addEventListener ? (c = a, o.addEventListener(s, c, !1)) : o.attachEvent && (c = function() {
						var e = window.event;
						e.target || (e.target = e.srcElement), e.preventDefault = t, e.stopPropagation = i, a(e)
					}, o.attachEvent("on" + s, c)), o[r] || (o[r] = e.guid()), n.hasOwnProperty(o[r]) || (n[o[r]] = {}), l = n[o[r]], l.hasOwnProperty(s) || (l[s] = []), l[s].push({
						func: c,
						orig: a,
						key: u
					})
				...
				s = function(t, i, o) {
					...
					if(i = i.toLowerCase(), t[r] && n[t[r]] && n[t[r]][i]) {
						s = n[t[r]][i];
						for(var u = s.length - 1; u >= 0 && (s[u].orig !== o && s[u].key !== o || (t.removeEventListener ? t.removeEventListener(i, s[u].func, !1) : t.detachEvent && t.detachEvent("on" + i, s[u].func), s[u].orig = null, s[u].func = null, s.splice(u, 1), o === a)); u--);
			...
			var t = function(i, n) {
					...
					if(r = !d && !u.scheme, (d || r) && (u.scheme = n.scheme), r) {
						...
						var h = "";
						/^[^\/]/.test(u.path) && (h = n.path, h = /\/[^\/]*\.[^\/]*$/.test(h) ? h.replace(/\/[^\/]+$/, "/") : h.replace(/\/?$/, "/")), u.path = h + (u.path || "")
					}
			...
			return i.extend(n.prototype, {
				...
				addEventListener: function(e, t, n, o) {
					...
					}), void 0) : (e = e.toLowerCase(), n = parseInt(n, 10) || 0, s = r[this.uid] && r[this.uid][e] || [], s.push({
						fn: t,
						priority: n,
						scope: o || this
					}), r[this.uid] || (r[this.uid] = {}), r[this.uid][e] = s, void 0)
				},
				...
				dispatchEvent: function(e) {
					...
					if("string" !== i.typeOf(e)) {
						...
						e = a.type, a.total !== u && a.loaded !== u && (c.total = a.total, c.loaded = a.loaded), c.async = a.async || !1
					}
					if(-1 !== e.indexOf("::") ? function(t) {
						...
						}), s = [].slice.call(arguments), s.shift(), c.type = e, s.unshift(c);
						var d = [];
						i.each(o, function(e) {
							s[0].target = e.scope, c.async ? d.push(function(t) {
								setTimeout(function() {
			...
			function r(e, n, o, a, u) {
				...
				e = e || {}, s[d] = this, o = t.extend({
					...
					upload_filesize: !0,
					use_http_method: !0
				}, o), e.preferred_caps && (h = r.getMode(a, e.preferred_caps, h)), c = function() {
					var e = {};
					return {
					...
					destroy: function() {
						if(l) {
							...
							e && e.parentNode.removeChild(e), c && c.removeAllInstances(), this.unbindAll(), delete s[this.uid], this.uid = null, d = l = c = e = null
						}
					}
					...
					extList2mimes: function(t, i) {
						...
						for(r = 0; r < t.length; r++)
							for(n = t[r].extensions.toLowerCase().split(/\s*,\s*/), o = 0; o < n.length; o++) {
								if("*" === n[o]) return [];
								if(s = a.mimes[n[o]], i && /^\w+$/.test(n[o])) u.push("." + n[o]);
								else if(s && -1 === e.inArray(s, u)) u.push(s);
								else if(!s) return []
							}
						return u
					},
			...
			return function() {
				...
				i.extend(this, {
					connectRuntime: function(r) {
						function o(i) {
							var s, u;
							return i.length ? (s = i.shift().toLowerCase(), (u = n.getConstructor(s)) ? (e = new u(r), e.bind("Init", function() {
							...
							}), e.mode ? (e.init(), void 0) : (e.trigger("Error"), void 0)) : (o(i), void 0)) : (a.trigger("RuntimeError", new t.RuntimeError(t.RuntimeError.NOT_INIT_ERR)), e = null, void 0)
						}
						var s, a = this;
		...
		}), n("moxie/file/FileInput", ["moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/core/utils/Mime", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/I18n", "moxie/runtime/Runtime", "moxie/runtime/RuntimeClient"], function(e, t, i, n, r, o, s, a, u) {
			function c(t) {
				var o, c, d;
				...
				}, t = e.extend({}, d, t), "string" == typeof t.required_caps && (t.required_caps = a.parseCaps(t.required_caps)), "string" == typeof t.accept && (t.accept = i.mimes2extList(t.accept)), o = n.get(t.container), o || (o = document.body), "static" === n.getStyle(o, "position") && (o.style.position = "relative"), o = c = null, u.call(this), e.extend(this, {
					uid: e.guid("uid_"),
					ruid: null,
					shimid: null,
					files: null,
					init: function() {
						...
						i.bind("RuntimeInit", function(r, o) {
							i.ruid = o.uid, i.shimid = o.shimid, i.bind("Ready", function() {
								...
								var i, r, s, a, u;
								s = n.get(t.browse_button), a = n.get(o.shimid), s && (i = n.getPos(s, n.get(t.container)), r = n.getSize(s), u = parseInt(n.getStyle(s, "z-index"), 10) || 0, a && e.extend(a.style, {
									top: i.y + "px",
									left: i.x + "px",
									width: r.w + "px",
									height: r.h + "px",
			...
			var e = function(e) {
				...
				i = function(e, i) {
					...
					var n, r, o, s, a, u, c, l, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
						h = 0,
						p = 0,
						m = "",
						f = [];
					if(!e) return e;
					e += "";
					do s = d.indexOf(e.charAt(h++)), a = d.indexOf(e.charAt(h++)), u = d.indexOf(e.charAt(h++)), c = d.indexOf(e.charAt(h++)), l = s << 18 | a << 12 | u << 6 | c, n = 255 & l >> 16, r = 255 & l >> 8, o = 255 & l, f[p++] = 64 == u ? String.fromCharCode(n) : 64 == c ? String.fromCharCode(n, r) : String.fromCharCode(n, r, o); while (h < e.length);
				...
				n = function(t, i) {
					...
					var n, r, o, s, a, u, c, l, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
						...
						f = [];
					if(!t) return t;
					do n = t.charCodeAt(h++), r = t.charCodeAt(h++), o = t.charCodeAt(h++), l = n << 16 | r << 8 | o, s = 63 & l >> 18, a = 63 & l >> 12, u = 63 & l >> 6, c = 63 & l, f[p++] = d.charAt(s) + d.charAt(a) + d.charAt(u) + d.charAt(c); while (h < t.length);
					m = f.join("");
					var g = t.length % 3;
			...
			function s() {
				function n(e, n) {
					if(this.trigger("loadstart"), this.readyState === s.LOADING) return this.trigger("error", new i.DOMException(i.DOMException.INVALID_STATE_ERR)), this.trigger("loadend"), void 0;
		...
		}), n("plupload", ["moxie/core/I18n", "moxie/core/utils/Env", "moxie/core/utils/Basic", "moxie/core/utils/Dom", "moxie/core/utils/Events", "moxie/core/utils/Url", "moxie/core/EventTarget", "moxie/runtime/Runtime", "moxie/file/FileInput", "moxie/file/FileReader"], function(e, t, i, n, r, o, s, a, u, c) {
			return t.global_event_dispatcher = "plupload.EventTarget.instance.dispatchEvent", {
				VERSION: "3.1.0",
				STOPPED: 1,
				STARTED: 2,
				QUEUED: 1,
				...
				inherit: i.inherit,
				extend: i.extend,
				extendImmutable: i.extendImmutable,
				extendIf: i.extendIf,
				inSeries: i.inSeries,
				inParallel: i.inParallel,
				guid: i.guid,
				getAll: function(e) {
					var t, r = [];
					"array" !== i.typeOf(e) && (e = [e]);
					for(var o = e.length; o--;) t = n.get(e[o]), t && r.push(t);
				...
				removeAllEvents: r.removeAllEvents,
				...
				formatSize: function(t) {
					...
					if(t = parseInt(t, 10), isNaN(t)) return e.translate("N/A");
					var n = Math.pow(1024, 4);
					return t > n ? i(t / n, 1) + " " + e.translate("tb") : t > (n /= 1024) ? i(t / n, 1) + " " + e.translate("gb") : t > (n /= 1024) ? i(t / n, 1) + " " + e.translate("mb") : t > 1024 ? Math.round(t / 1024) + " " + e.translate("kb") : t + " " + e.translate("b")
				},
		...
		}), n("plupload/core/Collection", ["moxie/core/utils/Basic"], function(e) {
			var t = function() {
				function i() {
					var e;
					for(e in r);
				...
				e.extend(this, {
					...
					add: function(t, i) {
						var s = this;
						return "object" != typeof t || i ? r.hasOwnProperty(t) ? s.update.apply(s, arguments) : (r[t] = n = i, o++, void 0) : e.each(t, function(e, t) {
							s.add(t, e)
						})
					},
					remove: function(e) {
					...
					shift: function() {
						var e, t, i = this;
						for(t in r) return e = r[t], i.remove(t), e
					},
					update: function(e, t) {
						r[e] = t
					},
					...
					combineWith: function() {
						var i = new t;
						return i.add(r), e.each(arguments, function(e) {
							e instanceof t && i.add(e.toObject())
						}), i
					},
					clear: function() {
						r = {}, n = null, o = 0
		...
		}), n("moxie/file/FileDrop", ["moxie/core/I18n", "moxie/core/utils/Dom", "moxie/core/Exceptions", "moxie/core/utils/Basic", "moxie/core/utils/Env", "moxie/file/File", "moxie/runtime/RuntimeClient", "moxie/core/EventTarget", "moxie/core/utils/Mime"], function(e, t, i, n, r, o, s, a, u) {
			function c(i) {
				var r, o = this;
				"string" == typeof i && (i = {
					drop_zone: i
				...
				}, i = "object" == typeof i ? n.extend({}, r, i) : r, i.container = t.get(i.drop_zone) || document.body, "static" === t.getStyle(i.container, "position") && (i.container.style.position = "relative"), "string" == typeof i.accept && (i.accept = u.mimes2extList(i.accept)), s.call(o), n.extend(o, {
					uid: n.guid("uid_"),
					ruid: null,
					files: null,
					init: function() {
		...
		}), n("plupload/core/ArrCollection", ["moxie/core/utils/Basic"], function(e) {
			var t = function() {
				var t = [];
				e.extend(this, {
					count: function() {
					...
					add: function(e) {
						e = arguments[1] || e;
						var i = this.getIdx(e.uid);
						return i > -1 ? (t[i] = e, i) : (t.push(e), t.length - 1)
					},
					remove: function(e) {
						return !!this.extract(e)
					},
					splice: function(i, n) {
						return i = "undefinded" === e.typeOf(i) ? 0 : Math.max(i, 0), n = "undefinded" !== e.typeOf(n) && i + n < t.length ? n : t.length - i, t.splice(i, n)
					},
					extract: function(e) {
						var i = this.getIdx(e);
					...
					toObject: function() {
						for(var e = {}, i = 0, n = t.length; n > i; i++) e[t[i].uid] = t[i];
						return e
					},
					toArray: function() {
			...
			return t
		}), n("plupload/core/Optionable", ["moxie/core/utils/Basic", "moxie/core/EventTarget"], function(e, t) {
			return function(t) {
				function i() {
				...
				return e.inherit(i, t), e.extend(i.prototype, {
					setOption: function(t, i, n) {
						var r, o = this;
						return "object" == typeof t ? (n = i, e.each(t, function(e, t) {
							o.setOption(t, e, n)
						}), void 0) : ((!n || o._options.hasOwnProperty(t)) && (r = e.clone(o._options[t]), "object" === e.typeOf(i) && "object" === e.typeOf(o._options[t]) ? e.extend(o._options[t], i) : o._options[t] = i, o.trigger("OptionChanged", t, i, r)), void 0)
					},
					...
					setOptions: function(e, t) {
						"object" == typeof e && this.setOption(e, t)
					},
					getOptions: function() {
		...
		}), n("plupload/core/Queueable", ["moxie/core/utils/Env", "moxie/core/utils/Basic", "plupload/core/Optionable"], function(e, t, i) {
			return function(e) {
				function i() {
				...
				return i.IDLE = 1, i.PROCESSING = 2, i.PAUSED = 6, i.RESUMED = 7, i.DONE = 5, i.FAILED = 4, i.DESTROYED = 8, t.inherit(i, e), t.extend(i.prototype, {
					...
					pause: function() {
						var e = this.state;
						return this.state !== i.PROCESSING ? !1 : (this.processed = this.percent = 0, this.loaded = this.processed, this.state = i.PAUSED, this.trigger("statechanged", this.state, e), this.trigger("paused"), !0)
					},
					resume: function() {
						var e = this.state;
						return this.state !== i.PAUSED && this.state !== i.RESUMED ? !1 : (this.state = i.RESUMED, this.trigger("statechanged", this.state, e), this.trigger("resumed"), !0)
					},
					stop: function() {
						var e = this.state;
						return this.state === i.IDLE ? !1 : (this.processed = this.percent = 0, this.loaded = this.processed, this.startedTimestamp = 0, this.state = i.IDLE, this.trigger("statechanged", this.state, e), this.trigger("stopped"), !0)
					},
					done: function(e) {
						var t = this.state;
						return this.state === i.DONE ? !1 : (this.processed = this.total, this.loaded = this.processed, this.percent = 100, this.processedTimestamp = +new Date, this.state = i.DONE, this.trigger("statechanged", this.state, t), this.trigger("done", e), this.trigger("processed"), !0)
					},
					failed: function(e) {
						var t = this.state;
						return this.state === i.FAILED ? !1 : (this.processed = this.percent = 0, this.loaded = this.processed, this.processedTimestamp = +new Date, this.state = i.FAILED, this.trigger("statechanged", this.state, t), this.trigger("failed", e), this.trigger("processed"), !0)
					},
					progress: function(e, t) {
						t && (this.total = t), this.processed = Math.min(e, this.total), this.loaded = this.processed, this.percent = Math.ceil(100 * (this.processed / this.total)), this.trigger({
							type: "progress",
					...
					destroy: function() {
						var e = this.state;
						return this.state === i.DESTROYED ? !1 : (this.state = i.DESTROYED, this.trigger("statechanged", this.state, e), this.trigger("destroy"), this.unbindAll(), !0)
					}
				}), i
			}(i)
		}), n("plupload/core/Stats", [], function() {
			return function() {
				var e = this;
				e.size = 0, e.total = 0, e.loaded = 0, e.uploaded = 0, e.done = 0, e.failed = 0, e.queued = 0, e.paused = 0, e.processing = 0, e.paused = 0, e.percent = 0, e.bytesPerSec = 0, e.processedPerSec = 0, e.reset = function() {
					e.size = e.total = e.loaded = e.processed = e.uploaded = e.done = e.failed = e.queued = e.processing = e.paused = e.percent = e.bytesPerSec = e.processedPerSec = 0
				}
			}
		}), n("plupload/core/Queue", ["moxie/core/utils/Basic", "plupload/core/ArrCollection", "plupload/core/Queueable", "plupload/core/Stats"], function(e, t, i, n) {
			return function(r) {
				function o(i) {
					r.apply(this, arguments), this._queue = new t, this.stats = new n, this._options = e.extend({}, this._options, {
						max_slots: 1,
						max_retries: 0,
						auto_start: !1,
						finish_active: !1
				...
				function s() {
					...
					return this.forEachItem(function(t) {
						return t.state === i.IDLE || t.state === i.RESUMED ? (e = t, !1) : void 0
					}), e ? e : null
				}

				function a() {
					var e;
					return this.state !== i.PROCESSING && this.state !== i.PAUSED ? !1 : this.stats.processing < this.getOption("max_slots") && (e = s.call(this)) ? (e.setOptions(this.getOptions()), e.start()) : !1
				}
				return e.inherit(o, r), e.extend(o.prototype, {
					count: function() {
						return this._queue.count()
					},
					start: function() {
						var e = this.state;
						return this.state === i.PROCESSING ? !1 : (this.startedTimestamp || (this.startedTimestamp = +new Date), this.state = i.PROCESSING, this.trigger("statechanged", this.state, e), this.trigger("started"), a.call(this))
					},
					pause: function() {
						return o.super.pause.call(this) ? (this.forEachItem(function(e) {
							e.pause()
						}), void 0) : !1
					},
					stop: function() {
						return !o.super.stop.call(this) || this.getOption("finish_active") ? !1 : (this.isActive() && this.forEachItem(function(e) {
							e.stop()
						}), void 0)
					},
					...
					addItem: function(t) {
						var n = this;
						t.bind("Started", function() {
							n.calcStats() && e.delay.call(n, a)
						}), t.bind("Resumed", function() {
							n.start()
						}), t.bind("Paused", function() {
							n.calcStats() && e.delay.call(n, function() {
								a.call(n) || n.stats.processing || n.pause()
							})
						}), t.bind("Processed Stopped", function() {
							n.calcStats() && e.delay.call(n, function() {
						...
						}), t.bind("Failed", function() {
							n.getOption("max_retries") && this.retries < n.getOption("max_retries") && (this.stop(), this.retries++)
						}), this._queue.add(t.uid, t), this.calcStats(), t.trigger("Queued"), (n.getOption("auto_start") || n.state === i.PAUSED) && e.delay.call(this, this.start)
					},
					extractItem: function(e) {
						var t = this._queue.get(e);
						return t && (this.stopItem(t.uid), this._queue.remove(e), this.calcStats()), t
					},
					removeItem: function(e) {
						var t = this.extractItem(e);
						return t ? (t.destroy(), !0) : !1
					},
					stopItem: function(e) {
						var t = this._queue.get(e);
						return t ? t.stop() : !1
					...
					resumeItem: function(t) {
						var i = this._queue.get(t);
						return i ? (e.delay.call(this, function() {
							this.start()
						}), i.resume()) : !1
					},
					splice: function(e, t) {
					...
					clear: function() {
						var e = this;
						return e.state !== i.IDLE ? (e.bindOnce("Stopped", function() {
							e.clear()
						}), e.stop()) : (e._queue.clear(), e.stats.reset(), void 0)
					},
					calcStats: function() {
						var e = this,
							t = e.stats,
							n = 0,
							r = 0;
						return t ? (t.reset(), e.forEachItem(function(o) {
							switch(o.state) {
								case i.DONE:
									t.done++, t.uploaded = t.done;
									break;
								case i.FAILED:
									t.failed++;
									break;
							...
							n += o.processed, (!o.processedTimestamp || o.processedTimestamp > e.startedTimestamp) && (r += n), t.processedPerSec = Math.ceil(r / ((+new Date - e.startedTimestamp || 1) / 1e3)), t.processed = n, t.total += o.total, t.total && (t.percent = Math.ceil(100 * (t.processed / t.total)))
						}), e.percent = t.percent, t.loaded = t.processed, t.size = t.total, t.bytesPerSec = t.processedPerSec, !0) : !1
					},
					destroy: function() {
						var t = this;
						return t.state === i.DESTROYED ? !1 : t.state !== i.IDLE ? (t.bindOnce("Stopped", function() {
							e.delay.call(t, t.destroy)
						}), t.stop()) : (t.clear(), o.super.destroy.call(this), t._queue = t.stats = null, !0)
					}
				}), o
			}(i)
		}), n("plupload/QueueUpload", ["moxie/core/utils/Basic", "plupload/core/Queue"], function(e, t) {
			return function(i) {
				function n(e) {
					t.call(this, {
						max_slots: 1,
						...
						"object" != typeof e && "max_upload_slots" == e && (e = "max_slots"), n.prototype.setOption.call(this, e, t, !0)
					}, this.setOptions(e)
				}
				return e.inherit(n, i), n
			}(t)
		}), n("plupload/QueueResize", ["moxie/core/utils/Basic", "plupload/core/Queue"], function(e, t) {
			return function(i) {
				function n(e) {
					t.call(this, {
						max_slots: 1,
						...
						"object" != typeof e && "max_resize_slots" == e && (e = "max_slots"), n.prototype.setOption.call(this, e, t, !0)
					}, this.setOptions(e)
				}
				return e.inherit(n, i), n
			}(t)
			...
			return n
		}), n("moxie/xhr/XMLHttpRequest", ["moxie/core/utils/Basic", "moxie/core/Exceptions", "moxie/core/EventTarget", "moxie/core/utils/Encode", "moxie/core/utils/Url", "moxie/runtime/Runtime", "moxie/runtime/RuntimeTarget", "moxie/file/Blob", "moxie/file/FileReaderSync", "moxie/xhr/FormData", "moxie/core/utils/Env", "moxie/core/utils/Mime"], function(e, t, i, n, r, o, s, a, u, c, l, d) {
			function h() {
			...
			function p() {
				function i(e, t) {
					return I.hasOwnProperty(e) ? 1 === arguments.length ? l.can("define_property") ? I[e] : O[e] : (l.can("define_property") ? I[e] = t : O[e] = t, void 0) : void 0
				}
				...
				function u(t) {
					...
					function r(r) {
						b.bind("LoadStart", function(e) {
							i("readyState", p.LOADING), a.dispatchEvent("readystatechange"), a.dispatchEvent(e), L && a.upload.dispatchEvent(e)
					...
					var a = this;
					E = (new Date).getTime(), b = new s, "string" == typeof U.required_caps && (U.required_caps = o.parseCaps(U.required_caps)), U.required_caps = e.extend({}, U.required_caps, {
						return_response_type: a.responseType
					}), t instanceof c && (U.required_caps.send_multipart = !0), e.isEmptyObj(A) || (U.required_caps.send_custom_headers = !0), P || (U.required_caps.do_cors = !0), U.ruid ? r(b.connectRuntime(U)) : (b.bind("RuntimeInit", function(e, t) {
						r(t)
				...
				function g() {
					i("responseText", ""), i("responseXML", null), i("response", null), i("status", 0), i("statusText", ""), E = w = null
				}
				var x, v, y, _, E, w, b, R, O = this,
					I = {
						timeout: 0,
						readyState: p.UNSENT,
						withCredentials: !1,
				...
				e.extend(this, I, {
					...
					open: function(o, s, a, u, c) {
						...
						if(s = n.utf8_encode(s), l = r.parseUrl(s), P = r.hasSameOrigin(l), x = r.resolveUrl(s), (u || c) && !P) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
						if(y = u || l.user, _ = c || l.pass, S = a || !0, S === !1 && (i("timeout") || i("withCredentials") || "" !== i("responseType"))) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
						C = !S, N = !1, A = {}, g.call(this), i("readyState", p.OPENED), this.dispatchEvent("readystatechange")
					},
					setRequestHeader: function(r, o) {
						...
						return r = e.trim(r).toLowerCase(), ~e.inArray(r, s) || /^(proxy\-|sec\-)/.test(r) ? !1 : (A[r] ? A[r] += ", " + o : A[r] = o, !0)
					},
					...
					send: function(i, r) {
						if(U = "string" === e.typeOf(r) ? {
								ruid: r
							} : r ? r : {}, this.readyState !== p.OPENED || N) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
						if(i instanceof a) U.ruid = i.ruid, D = i.type || "application/octet-stream";
						...
						this.withCredentials || (this.withCredentials = U.required_caps && U.required_caps.send_browser_cookies && !P), L = !C && this.upload.hasEventListener(), M = !1, F = !i, C || (N = !0), u.call(this, i)
					},
					abort: function() {
						if(M = !0, C = !1, ~e.inArray(i("readyState"), [p.UNSENT, p.OPENED, p.DONE])) i("readyState", p.UNSENT);
						else {
							if(i("readyState", p.DONE), N = !1, !b) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
							b.getRuntime().exec.call(b, "XMLHttpRequest", "abort", F), F = !0
						}
					},
					destroy: function() {
		...
		}), n("plupload/ChunkUploader", ["moxie/core/utils/Basic", "plupload/core/Collection", "plupload/core/Queueable", "moxie/xhr/XMLHttpRequest", "moxie/xhr/FormData"], function(e, t, i, n, r) {
			function o(t) {
				function s(t, i) {
					var n = "";
				...
				i.call(this), this._options = {
					...
					start: function() {
						var u, c, l = this,
							d = l._options;
						if(this.state === i.PROCESSING) return !1;
						a = new n, a.upload && (a.upload.onprogress = function(e) {
							l.progress(e.loaded, e.total)
						}), a.onload = function() {
							var e = {
							...
							return this.status >= 400 ? l.failed(e) : (l.done(e), void 0)
						}, a.onerror = function() {
							l.failed()
						...
						try {
							u = d.multipart ? d.url : s(d.url, d.params), a.open(d.http_method, u, !0), e.isEmptyObj(d.headers) || e.each(d.headers, function(e, t) {
								a.setRequestHeader(t, e)
							}), d.multipart ? (c = new r, e.isEmptyObj(d.params) || e.each(d.params, function(e, t) {
								c.append(t, e)
							}), c.append(d.file_data_name, t), a.send(c)) : ((e.isEmptyObj(d.headers) || !a.hasRequestHeader("content-type")) && a.setRequestHeader("content-type", "application/octet-stream"), a.send(t)), o.prototype.start.call(this)
						} catch(h) {
							l.failed()
						}
					},
					stop: function() {
						a && (a.abort(), a.destroy(), a = null), o.prototype.stop.call(this)
					},
					setOption: function(e, t) {
						o.prototype.setOption.call(this, e, t, !0)
					},
					setOptions: function(e) {
						o.prototype.setOption.call(this, e, !0)
					},
					destroy: function() {
						this.stop(), o.prototype.destroy.call(this)
					}
				})
			}
			return e.inherit(o, i), o
		}), n("plupload/FileUploader", ["moxie/core/utils/Basic", "plupload/core/Collection", "plupload/core/Queueable", "plupload/ChunkUploader"], function(e, t, i, n) {
			function r(o, s) {
				function a() {
					var e = 0;
					return c.each(function(t) {
						t.state === i.DONE && (e += t.end - t.start)
					}), e
				}

				function u() {
					for(var e = 0; l > e && c.hasKey(e);) e++;
					return e
				}
				var c = new t,
					l = 1;
				i.call(this), this._options = {
					...
					start: function() {
						var e, t = this,
							a = this.state;
						return this.state === i.PROCESSING ? !1 : this.state !== i.IDLE || r.prototype.start.call(t) ? (t._options.send_file_name && (t._options.params.name = t.target_name || t.name), t._options.chunk_size ? (l = Math.ceil(o.size / t._options.chunk_size), t.uploadChunk(!1, !0)) : (e = new n(o), e.bind("progress", function(e) {
							t.progress(e.loaded, e.total)
						}), e.bind("done", function(e, i) {
							t.done(i)
						}), e.bind("failed", function(e, i) {
							t.failed(i)
						}), e.setOptions(t._options), s.addItem(e)), this.state = i.PROCESSING, this.trigger("statechanged", this.state, a), this.trigger("started"), !0) : !1
					},
					uploadChunk: function(t, r) {
						var d, h, p = this,
							m = this.getOption("chunk_size"),
							f = {};
						return f.seq = parseInt(t, 10) || u(), f.start = f.seq * m, f.end = Math.min(f.start + m, o.size), f.total = o.size, f.start < 0 || f.start >= o.size ? !1 : (h = e.extendImmutable({}, this.getOptions(), {
							params: {
								chunk: f.seq,
								chunks: l
							}
						}), d = new n(o.slice(f.start, f.end, o.type)), d.bind("progress", function(e) {
							p.progress(a() + e.loaded, o.size)
						}), d.bind("failed", function(t, n) {
							c.add(f.seq, e.extend({
								state: i.FAILED
							}, f)), p.trigger("chunkuploadfailed", e.extendImmutable({}, f, n)), h.stop_on_fail && p.failed(n)
						}), d.bind("done", function(t, n) {
							c.add(f.seq, e.extend({
								state: i.DONE
							}, f)), p.trigger("chunkuploaded", e.extendImmutable({}, f, n)), a() >= o.size ? (p.progress(o.size, o.size), p.done(n)) : r && e.delay(function() {
								p.uploadChunk(u(), r)
							})
						}), d.bind("processed", function() {
							this.destroy()
						}), d.setOptions(h), c.add(f.seq, e.extend({
							state: i.PROCESSING
						}, f)), s.addItem(d), r && s.countSpareSlots() && p.uploadChunk(u(), r), !0)
					},
					destroy: function() {
						r.prototype.destroy.call(this), c.clear()
					}
				})
			}
			return e.inherit(r, i), r
			...
			function r() {
				...
				function o(t, i) {
					...
					u = i, n.bind("TransportingProgress", function(t) {
						d = t.loaded, l > d && -1 === e.inArray(n.state, [r.IDLE, r.DONE]) && s.call(n)
				...
				function s() {
					var e, i = this,
						n = l - d;
					h > n && (h = n), e = t.btoa(c.substr(d, h)), u.exec.call(i, "Transporter", "receive", e, l)
				}
				var a, u, c, l, d, h;
				i.call(this), e.extend(this, {
					...
					transport: function(t, i, r) {
						...
						if(r = e.extend({
								chunk_size: 204798
							}, r), (a = r.chunk_size % 3) && (r.chunk_size += 3 - a), h = r.chunk_size, n.call(this), c = t, l = t.length, "string" === e.typeOf(r) || r.ruid) o.call(s, i, this.connectRuntime(r));
						else {
							var u = function(e, t) {
						...
						function o(t, r) {
							...
							if(u.can("use_data_uri_of", d.length)) n.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" />', o.destroy(), c.trigger("embedded");
								...
								p.bind("TransportingComplete", function() {
									s = c.connectRuntime(this.result.ruid), c.bind("Embedded", function() {
									...
									}, 999), s.exec.call(c, "ImageView", "display", this.result.uid, width, height), o.destroy()
								}), p.transport(h.atob(d.substring(d.indexOf("base64,") + 7)), t, {
									required_caps: {
										display_media: !0
									},
			...
			return p.MAX_RESIZE_WIDTH = 8192, p.MAX_RESIZE_HEIGHT = 8192, p.prototype = c.instance, p
		}), n("plupload/ImageResizer", ["plupload", "plupload/core/Queueable", "moxie/image/Image"], function(e, t, i) {
			function n(e) {
				t.call(this), this._options = {
					width: 0,
					height: 0,
					type: "image/jpeg",
					quality: 90,
					...
					("object" == typeof e || this._options.hasOwnProperty(e)) && n.prototype.setOption.apply(this, arguments)
				}, this.start = function(t) {
					var n, r = this;
					t && this.setOptions(t.resize), n = new i, n.bind("load", function() {
						this.resize(r.getOptions())
					}), n.bind("resize", function() {
						r.done(this.getAsBlob(r.getOption("type"), r.getOption("quality"))), this.destroy()
					}), n.bind("error", function() {
						r.failed(), this.destroy()
					}), n.load(e)
				}
			}
			return e.inherit(n, t), e.Image = i, n
		}), n("plupload/File", ["plupload", "plupload/core/Queueable", "plupload/FileUploader", "plupload/ImageResizer"], function(e, t, i, n) {
			function r(a, u, c) {
				t.call(this), e.extend(this, {
					id: this.uid,
					name: a.name,
					...
					start: function() {
						var i = this.state;
						return this.state === t.PROCESSING ? !1 : (this.state = t.PROCESSING, this.trigger("statechanged", this.state, i), this.trigger("started"), !e.isEmptyObj(this._options.resize) && o(this.type) && s(a, "send_binary_string") ? this.resizeAndUpload() : this.upload(), !0)
					},
					getSource: function() {
						return a
					},
					...
					upload: function() {
						var e = this,
							t = new i(a, u);
						t.bind("beforestart", function() {
							return e.trigger("beforeupload")
						}), t.bind("paused", function() {
							e.pause()
						}), t.bind("resumed", function() {
							this.start()
						}), t.bind("started", function() {
							e.trigger("startupload")
						}), t.bind("progress", function(t) {
							e.progress(t.loaded, t.total)
						}), t.bind("done", function(t, i) {
							e.done(i)
							...
							e.failed(i)
						}), t.setOptions(e.getOptions()), t.start()
					},
					destroy: function() {
			...
			function o(t) {
				return e.inArray(t, ["image/jpeg", "image/png"]) > -1
			}

			function s(t, i) {
				if(t.ruid) {
					var n = e.Runtime.getInfo(t.ruid);
					if(n) return n.can(i)
				}
				return !1
			}
			return e.inherit(r, t), r
		}), n("plupload/Uploader", ["plupload", "plupload/core/Collection", "moxie/core/utils/Mime", "moxie/file/Blob", "moxie/file/File", "moxie/file/FileInput", "moxie/file/FileDrop", "moxie/runtime/Runtime", "plupload/core/Queue", "plupload/QueueUpload", "plupload/QueueResize", "plupload/File"], function(e, t, i, n, r, o, s, a, u, c, l, d) {
			function h(t) {
				function i() {
					var e = R[0] || O[0];
				...
				function p() {
					...
					}, this, 999), this.bind("BeforeUpload", x), this.bind("Stopped", function(e) {
						e.trigger("UploadComplete")
					}), this.bind("Error", _), this.bind("Destroy", E)
				}
				...
				function g(t) {
					var i = this,
						...
						r = [],
						u = {
							runtime_order: i.getOption("runtimes"),
							required_caps: i.getOption("required_features"),
							preferred_caps: i.getOption("preferred_caps"),
							swf_url: i.getOption("flash_swf_url"),
							xap_url: i.getOption("silverlight_xap_url")
						};
					e.each(i.getOption("runtimes").split(/\s*,\s*/), function(e) {
						i.getOption(e) && (u[e] = i.getOption(e))
					}), i.getOption("browse_button") && e.each(i.getOption("browse_button"), function(t) {
						r.push(function(r) {
							var s = new o(e.extend({}, u, {
								accept: i.getOption("filters").mime_types,
								name: i.getOption("file_data_name"),
								multiple: i.getOption("multi_selection"),
								container: i.getOption("container"),
								browse_button: t
							}));
							s.onready = function() {
								var t = a.getInfo(this.ruid);
								e.extend(i.features, {
							...
							}, s.bind("mouseenter mouseleave mousedown mouseup", function(n) {
								S || (i.getOption("browse_button_hover") && ("mouseenter" === n.type ? e.addClass(t, i.getOption("browse_button_hover")) : "mouseleave" === n.type && e.removeClass(t, i.getOption("browse_button_hover"))), i.getOption("browse_button_active") && ("mousedown" === n.type ? e.addClass(t, i.getOption("browse_button_active")) : "mouseup" === n.type && e.removeClass(t, i.getOption("browse_button_active"))))
					...
					}), i.getOption("drop_element") && e.each(i.getOption("drop_element"), function(t) {
						r.push(function(r) {
							var o = new s(e.extend({}, u, {
								drop_zone: t
							}));
							o.onready = function() {
								var t = a.getInfo(this.ruid);
					...
					}), e.inParallel(r, function() {
						"function" == typeof t && t(n)
					})
				}

				function x(e, t) {
					if(e.getOption("unique_names")) {
						var i = t.name.match(/\.([^.]+)$/),
							n = "part";
				...
				function E(t) {
					t.forEachItem(function(e) {
						e.destroy()
					}), R.length && (e.each(R, function(e) {
						e.destroy()
					}), R = []), O.length && (e.each(O, function(e) {
						e.destroy()
					}), O = []), I = !1, w && w.destroy(), b && b.destroy(), A = w = b = null
				}
				var w, b, R = [],
					O = [],
					I = !1,
				...
				u.call(this), e.extend(this, {
					...
					init: function() {
						var t, n, r = this;
						return t = r.getOption("preinit"), "function" == typeof t ? t(r) : e.each(t, function(e, t) {
							r.bind(t, e)
						}), p.call(r), e.each(["container", "browse_button", "drop_element"], function(t) {
							return null === r.getOption(t) ? (n = {
								code: e.INIT_ERROR,
								message: e.sprintf(e.translate("%s specified, but cannot be found."), t)
							}, !1) : void 0
						}), n ? r.trigger("Error", n) : r.getOption("browse_button") || r.getOption("drop_element") ? (g.call(r, function(t) {
							var n, o = r.getOption("init"),
								s = e.extendImmutable({}, r.getOption(), {
									auto_start: !0
								});
							"function" == typeof o ? o(r) : e.each(o, function(e, t) {
								r.bind(t, e)
							}), t ? (I = !0, n = a.getInfo(i()), w = new c(s), b = new l(s), r.trigger("Init", {
								ruid: n.uid,
								runtime: r.runtime = n.type
							}), r.trigger("PostInit")) : r.trigger("Error", {
								code: e.INIT_ERROR,
								message: e.translate("Init error.")
							})
						}), void 0) : r.trigger("Error", {
							code: e.INIT_ERROR,
							message: e.translate("You must specify either browse_button or drop_element.")
						})
					},
					setOption: function(t, i) {
						return I && e.inArray(t, ["container", "browse_button", "drop_element", "runtimes", "multi_selection", "flash_swf_url", "silverlight_xap_url"]) > -1 ? this.trigger("Error", {
							code: e.OPTION_ERROR,
							message: e.sprintf(e.translate("%s option cannot be changed.")),
							option: t
						}) : ("object" != typeof t && (i = f(t, i, this._options), w && w.setOption(t, i), b && b.setOption(t, i)), h.prototype.setOption.call(this, t, i), void 0)
					},
					refresh: function() {
						R.length && e.each(R, function(e) {
							e.trigger("Refresh")
						}), O.length && e.each(O, function(e) {
							e.trigger("Refresh")
						}), this.trigger("Refresh")
					},
					stop: function() {
						h.prototype.stop.call(this) && this.state != e.STOPPED && this.trigger("CancelUpload")
					},
					disableBrowse: function() {
						S = arguments[0] !== v ? arguments[0] : !0, R.length && e.each(R, function(e) {
							e.disable(S)
						}), this.trigger("DisableBrowse", S)
					},
					getFile: function(e) {
						return this.getItem(e)
					},
					addFile: function(t, o) {
						function s(t) {
							t.bind("beforeupload", function(e) {
								return l.trigger("BeforeUpload", e.target)
							}), t.bind("startupload", function() {
								l.trigger("UploadFile", this)
							}), t.bind("progress", function() {
								l.trigger("UploadProgress", this)
							}), t.bind("done", function(e, t) {
								l.trigger("FileUploaded", this, t)
							}), t.bind("failed", function(t, i) {
								l.trigger("Error", e.extend({
									code: e.HTTP_ERROR,
						...
						function a(t, i) {
							var n = [];
							e.each(l.getOption("filters"), function(e, i) {
								y[i] && n.push(function(n) {
									y[i].call(l, e, t, function(e) {
										n(!e)
									})
								})
							}), e.inParallel(n, i)
						...
						function u(t) {
							...
							if(t instanceof r) {
								if(!t.ruid && !t.isDetached()) {
									if(!c) return !1;
									t.ruid = c, t.connectRuntime(c)
								}
								h.push(function(i) {
									a(t, function(n) {
										var r;
										n || (r = new d(t, w, b), o && (r.name = o), s(r), l.addItem(r), p.push(r), l.trigger("FileFiltered", r)), e.delay(i)
									})
								})
							} else t instanceof n ? (u(t.getSource()), t.destroy()) : -1 !== e.inArray(i, ["file", "blob"]) ? u(new r(null, t)) : "node" === i && "filelist" === e.typeOf(t.files) ? e.each(t.files, u) : "array" === i && (o = null, e.each(t, u))
						}
						var c, l = this,
							h = [],
							p = [];
						c = i(), u(t), h.length && e.inParallel(h, function() {
							p.length && l.trigger("FilesAdded", p)
						})
					},
					removeFile: function(e) {
						var t = this.extractItem("string" == typeof e ? e : e.uid);
						t && (this.trigger("FilesRemoved", [t]), t.destroy())
					},
					splice: function() {
						var t = 0,
							i = e.STARTED == this.state,
							n = u.prototype.splice.apply(this, arguments);
						if(n.length) {
							for(this.trigger("FilesRemoved", n), i && this.stop(), t = 0; t < n.length; t++) n[t].destroy();
							i && this.start()
						}
					},
					dispatchEvent: function(e) {
				...
				}), A.backward_compatibility && (this.bind("FilesAdded FilesRemoved", function(e) {
					e.files = e.toArray()
			...
			function p(t) {
				...
				var n = t.required_features,
					r = {};
				return "string" == typeof n ? e.each(n.split(/\s*,\s*/), function(e) {
					i(e, !0)
				}) : "object" == typeof n ? e.each(n, function(e, t) {
					i(t, e)
				}) : n === !0 && (t.chunk_size && t.chunk_size > 0 && (r.slice_blob = !0), e.isEmptyObj(t.resize) && t.multipart !== !1 || (r.send_binary_string = !0), t.http_method && (r.use_http_method = t.http_method), e.each(t, function(e, t) {
					i(t, !!e, !0)
				})), r
			}
			...
			function f(t, n, r) {
				switch(t) {
					case "chunk_size":
						(n = e.parseSize(n)) && (r.send_file_name = !0);
						break;
					case "headers":
						var o = {};
					...
					case "http_method":
						return "PUT" === n.toUpperCase() ? "PUT" : "POST";
					case "filters":
						return "array" === e.typeOf(n) && (n = {
							mime_types: n
						}), n.mime_types && ("string" === e.typeOf(n.mime_types) && (n.mime_types = i.mimes2extList(n.mime_types)), r.re_ext_filter = function(t) {
							var i = [];
							return e.each(t, function(t) {
								e.each(t.extensions.split(/,/), function(e) {
									/^\s*\*\s*$/.test(e) ? i.push("\\.*") : i.push("\\." + e.replace(new RegExp("[" + "/^$.*+?|()[]{}\\".replace(/./g, "\\$&") + "]", "g"), "\\$&"))
								})
							}), new RegExp("(" + i.join("|") + ")$", "i")
						}(n.mime_types)), n;
					case "max_file_size":
						r && !r.filters && (r.filters = {}), r.filters.max_file_size = n;
						break;
					case "multipart":
						n || (r.send_file_name = !0);
						break;
					case "multipart_params":
						r.params = r.multipart_params = n;
						break;
					case "resize":
						return n ? e.extend({
							preserve_headers: !0,
					...
					case "prevent_duplicates":
						r && !r.filters && (r.filters = {}), r.filters.prevent_duplicates = !!n;
						break;
					case "unique_names":
						n && (r.send_file_name = !0);
						break;
					...
					case "browse_button":
					case "drop_element":
						return "container" === t ? e.get(n) : e.getAll(n)
				}
				return n
			}
			...
			function x(e, t) {
				var i, n;
				return i = new h(e), n = a.thatCan(i.getOption("required_features"), t || e.runtimes), i.destroy(), n
			}
			var v, y = {};
			return g("mime_types", function(t, i, n) {
			...
			}), g("max_file_size", function(t, i, n) {
				var r;
			...
			}), g("prevent_duplicates", function(t, i, n) {
				var r = this;
			...
			}), h.addFileFilter = g, e.inherit(h, u), e.addFileFilter = g, e.predictRuntime = x, h
			...
			function o(t) {
				...
				i.call(this, t, arguments[1] || s, l), e.extend(this, {
					init: function() {
						this.trigger("Init")
					},
					destroy: function(e) {
			...
			function a() {
				...
				i.extend(this, {
					init: function(u) {
						...
						e = u, d = o.extList2mimes(e.accept, g.can("filter_by_extension")), l = g.getShimContainer(), l.innerHTML = '<input id="' + g.uid + '" type="file" style="font-size:999px;opacity:0;"' + (e.multiple && g.can("select_multiple") ? "multiple" : "") + (e.directory && g.can("select_folder") ? "webkitdirectory directory" : "") + (d ? ' accept="' + d.join(",") + '"' : "") + " />", c = n.get(g.uid), i.extend(c.style, {
						...
						})), m = g.can("summon_file_dialog") ? h : l, r.addEvent(m, "mouseover", function() {
							...
							f.trigger("mouseup")
						}, f.uid), c.onchange = function x() {
							if(f.files = [], i.each(this.files, function(i) {
									var n = "";
									return e.directory && "." == i.name ? !0 : (i.webkitRelativePath && (n = "/" + i.webkitRelativePath.replace(/^\//, "")), i = new t(g.uid, i), i.relativePath = n, f.files.push(i), void 0)
			...
			function s() {
				...
				i.extend(this, {
					...
					destroy: function() {
						r.removeAllEvents(p && n.get(p.container), this.uid), m = f = g = p = null
					}
				})
			}
			return e.FileDrop = s
				...
				t.extend(this, {
					send: function(i, r) {
						var a = this,
							...
							m = "Android Browser" === u.browser,
							f = !1;
						if(p = i.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), h = c(), h.open(i.method, i.url, i.async, i.user, i.password), r instanceof o) r.isDetached() && (f = !0), r = r.getSource();
						else if(r instanceof s) {
							if(r.hasBlob())
								if(r.getBlob().isDetached()) r = d.call(a, r), f = !0;
								else if((l || m) && "blob" === t.typeOf(r.getBlob().getSource()) && window.FileReader) return e.call(a, i, r), void 0;
							if(r instanceof s) {
						...
						h.upload ? (i.withCredentials && (h.withCredentials = !0), h.addEventListener("load", function(e) {
							...
							switch(h.readyState) {
								...
								case 3:
									...
									break;
								case 4:
									h.onreadystatechange = function() {}, 0 === h.status ? a.trigger("error") : a.trigger("load")
							}
						}, t.isEmptyObj(i.headers) || t.each(i.headers, function(e, t) {
							h.setRequestHeader(t, e)
						}), "" !== i.responseType && "responseType" in h && (h.responseType = "json" !== i.responseType || u.can("return_response_type", "json") ? i.responseType : "text"), f ? h.sendAsBinary ? h.sendAsBinary(r) : function() {
			...
			return function i(n) {
				...
				for(o = 2; o <= r.length();)
					if(s = r.SHORT(o), s >= 65488 && 65495 >= s) o += 2;
					else {
						if(65498 === s || 65497 === s) break;
						u = r.SHORT(o + 2) + 2, s >= 65505 && 65519 >= s && a.push({
							hex: s,
							name: "APP" + (15 & s),
							start: o,
							length: u,
			...
			function r(o) {
				function s(i, r) {
					...
					for(o = f.SHORT(i), s = 0; o > s; s++)
						if(g = [], p = i + 2 + 12 * s, a = r[f.SHORT(p)], a !== t) {
							if(u = v[f.SHORT(p += 2)], c = f.LONG(p += 2), h = y[u], !h) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
							if(p += 4, h * c > 4 && (p = f.LONG(p) + d.tiffHeader), p + h * c >= this.length()) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
							"ASCII" !== u ? (g = f.asArray(u, p, c), m = 1 == c ? g[0] : g, x[a] = l.hasOwnProperty(a) && "object" != typeof m ? l[a][m] : m) : x[a] = e.trim(f.STRING(p, c).replace(/\0$/, ""))
						}
					return x
				}
				...
				if(i.call(this, o), c = {
						...
						setExif: function(e, t) {
							return "PixelXDimension" !== e && "PixelYDimension" !== e ? !1 : a.call(this, "exif", e, t)
						},
						clear: function() {
							u.clear(), o = c = l = p = d = u = null
						}
					}), 65505 !== this.SHORT(0) || "EXIF\0" !== this.STRING(4, 5).toUpperCase()) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
				if(this.littleEndian = 18761 == this.SHORT(h), 42 !== this.SHORT(h += 2)) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
				d.IFD0 = d.tiffHeader + this.LONG(h += 2), p = s.call(this, d.IFD0, c.tiff), "ExifIFDPointer" in p && (d.exifIFD = d.tiffHeader + p.ExifIFDPointer, delete p.ExifIFDPointer), "GPSInfoIFDPointer" in p && (d.gpsIFD = d.tiffHeader + p.GPSInfoIFDPointer, delete p.GPSInfoIFDPointer), e.isEmptyObj(p) && (p = null);
			...
			function c() {
				...
				function f() {
					x && (x.purge(), x = null), y = g = v = _ = null, w = !1
				}
				var g, x, v, y, _, E = this,
					w = !1,
					b = !0;
				t.extend(this, {
					loadFromBlob: function(e) {
						...
						return _ = e, e.isDetached() ? (y = e.getSource(), h.call(this, y), void 0) : (p.call(this, e.getSource(), function(e) {
							n && (y = l(e)), h.call(this, e)
						}), void 0)
					},
					loadFromImage: function(e, t) {
						this.meta = e.meta, _ = new o(null, {
							...
							size: e.size,
							type: e.type
						}), h.call(this, t ? y = e.getAsBinaryString() : e.getAsDataURL())
					},
					getInfo: function() {
						var t, i = this.getRuntime();
						return !x && y && i.can("access_image_binary") && (x = new s(y)), t = {
							width: e().width || 0,
							height: e().height || 0,
							...
							name: _.name || "",
							meta: null
						}, b && (t.meta = x && x.meta || this.meta || {}, !t.meta || !t.meta.thumb || t.meta.thumb.data instanceof r || (t.meta.thumb.data = new r(null, {
							type: "image/jpeg",
					...
					resize: function(t, i, n) {
						...
						if(r.width = t.width, r.height = t.height, r.getContext("2d").drawImage(e(), t.x, t.y, t.width, t.height, 0, 0, r.width, r.height), v = a.scale(r, i), b = n.preserveHeaders, !b) {
							var o = this.meta && this.meta.tiff && this.meta.tiff.Orientation || 1;
							v = m(v, o)
						}
						this.width = v.width, this.height = v.height, w = !0, this.trigger("Resize")
					},
					getAsCanvas: function() {
					...
					getAsBinaryString: function(e, t) {
						if(!w) return y || (y = l(E.getAsDataURL(e, t))), y;
						if("image/jpeg" !== e) y = l(E.getAsDataURL(e, t));
							...
							y = l(i), x && (y = x.stripHeaders(y), b && (x.meta && x.meta.exif && x.setExif({
					...
					destroy: function() {
						E = null, f.call(this), this.getRuntime().getShim().removeInstance(this.uid)
					}
				})
			}
			return e.Image = c
			...
			function c(u) {
				...
				u = e.extend({
					...
					return_response_headers: !1,
					return_response_type: function(t) {
						return "json" === t && window.JSON ? !0 : !e.arrayDiff(t, ["", "text", "document"]) || "browser" === h.mode
					},
					...
					destroy: function(e) {
						return function() {
							a(h.uid), e.call(h), clearTimeout(c), u = c = e = h = null
						}
					}(this.destroy)
				}, d)
			}
			...
			function a(a) {
				...
				a = e.extend({
					...
					destroy: function(e) {
						return function() {
							e.call(d), clearTimeout(l), a = l = e = d = null
						}
					}(this.destroy)
				}, c)
			}
			...
			return e.Image = t.extend({}, n, {
				getInfo: function() {
					...
					return o.meta && (t.each(n, function(e) {
						...
						if(a && a.keys)
							for(r.meta[e] = {}, i = 0, n = a.keys.length; n > i; i++) t = a.keys[i], s = a[t], s && (/^(\d|[1-9]\d+)$/.test(s) ? s = parseInt(s, 10) : /^\d*\.\d+$/.test(s) && (s = parseFloat(s)), r.meta[e][t] = s)
			...
			function a() {
				function e() {
					var o, c, d, h, p, m, f = this,
						g = f.getRuntime();
					m = i.guid("uid_"), o = g.getShimContainer(), a && (d = n.get(a + "_form"), d && i.extend(d.style, {
						top: "100%"
					})), h = document.createElement("form"), h.setAttribute("id", m + "_form"), h.setAttribute("method", "post"), h.setAttribute("enctype", "multipart/form-data"), h.setAttribute("encoding", "multipart/form-data"), i.extend(h.style, {
						overflow: "hidden",
						position: "absolute",
						top: 0,
						left: 0,
						width: "100%",
						height: "100%"
					}), p = document.createElement("input"), p.setAttribute("id", m), p.setAttribute("type", "file"), p.setAttribute("accept", l.join(",")), i.extend(p.style, {
						fontSize: "999px",
						opacity: 0
						...
						if(this.value) {
							if(this.files) {
								if(i = this.files[0], 0 === i.size) return h.parentNode.removeChild(h), void 0
							} else i = {
								name: this.value
							};
					...
					}, g.can("summon_file_dialog") && (c = n.get(u.browse_button), r.removeEvent(c, "click", f.uid), r.addEvent(c, "click", function(e) {
						p && !p.disabled && p.click(), e.preventDefault()
					}, f.uid)), a = m, o = d = c = null
				}
				var a, u, c, l = [];
				i.extend(this, {
					init: function(t) {
						var i, s = this,
							a = s.getRuntime();
						u = t, l = o.extList2mimes(t.accept, a.can("filter_by_extension")), i = a.getShimContainer(),
							function() {
								var e, o, l;
								e = n.get(t.browse_button), c = n.getStyle(e, "z-index") || "auto", a.can("summon_file_dialog") && ("static" === n.getStyle(e, "position") && (e.style.position = "relative"), s.bind("Refresh", function() {
									o = parseInt(c, 10) || 1, n.get(u.browse_button).style.zIndex = o, this.getRuntime().getShimContainer().style.zIndex = o - 1
								})), l = a.can("summon_file_dialog") ? e : i, r.addEvent(l, "mouseover", function() {
									s.trigger("mouseenter")
								}, s.uid), r.addEvent(l, "mouseout", function() {
									s.trigger("mouseleave")
								}, s.uid), r.addEvent(l, "mousedown", function() {
									s.trigger("mousedown")
					...
					setOption: function(e, t) {
						...
						"accept" == e && (l = t.mimes || o.extList2mimes(t, r.can("filter_by_extension"))), i = n.get(a), i && i.setAttribute("accept", l.join(","))
					},
					disable: function(e) {
						var t;
					...
					destroy: function() {
						...
						o && r.removeAllEvents(o, this.uid), s && (r.removeAllEvents(s, this.uid), s.style.zIndex = c), i && (r.removeAllEvents(i, this.uid), i.innerHTML = ""), t.removeInstance(this.uid), a = l = u = i = o = s = t = null
					}
				})
			}
			return e.FileInput = a
			...
			function u() {
				function e(e) {
					...
					if(l) {
						...
						setTimeout(function() {
							o.removeEvent(l, "load", a.uid), l.parentNode && l.parentNode.removeChild(l);
				...
				t.extend(this, {
					send: function(d, h) {
						function p() {
							...
							r.innerHTML = '<iframe id="' + m + '_iframe" name="' + m + '_iframe" src="javascript:&quot;&quot;" style="display:none"></iframe>', l = r.firstChild, i.appendChild(l), o.addEvent(l, "load", function() {
								var i;
								try {
						...
						if(u = c = null, h instanceof a && h.hasBlob()) {
							if(x = h.getBlob(), m = x.uid, g = i.get(m), f = i.get(m + "_form"), !f) throw new r.DOMException(r.DOMException.NOT_FOUND_ERR)
						} else m = t.guid("uid_"), f = document.createElement("form"), f.setAttribute("id", m + "_form"), f.setAttribute("method", d.method), f.setAttribute("enctype", "multipart/form-data"), f.setAttribute("encoding", "multipart/form-data"), y.getShimContainer().appendChild(f);
						f.setAttribute("target", m + "_iframe"), h instanceof a && h.each(function(e, i) {
							if(e instanceof s) g && g.setAttribute("name", i);
								...
								t.extend(n, {
									...
									name: i,
									value: e
								}), g ? f.insertBefore(n, g) : f.appendChild(n)
							}
						}), f.setAttribute("action", d.url), p(), f.submit(), v.trigger("loadstart")
					},
					getStatus: function() {
						return u
					},
